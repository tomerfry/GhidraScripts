...
def set_plate_comment(func, comment):
...
def run():
    ...
    # Generate and apply comment
    comment = format_security_comment(func, constraints, loops, dangerous_calls)
    print("\n" + comment)
    
    set_plate_comment(func, comment)
    print("\n[+] Plate comment added")
